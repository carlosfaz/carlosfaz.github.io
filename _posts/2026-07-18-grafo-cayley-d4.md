...
<div style="display: flex; justify-content: center; gap: 2em; margin: 1.5em 0; flex-wrap: wrap;">
  <div style="text-align: center;">
    <img src="/svg-inkscape/cayley-graph-d4.svg" alt="Grafo de Cayley del grupo diédrico D4 - Versión 1" style="max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); transform: scale(1.3); transform-origin: center;">
  </div>
  <div style="text-align: center;">
    <img src="/svg-inkscape/cayley-graph-d4_2.svg" alt="Grafo de Cayley del grupo diédrico D4 - Versión 2" style="max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); transform: scale(1.3); transform-origin: center;">
  </div>
</div>
